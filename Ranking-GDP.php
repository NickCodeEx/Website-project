...
<html>
      ...
      <hr>
      <h3>Ranking per Gross Domestic Gross</h3> 
...
<ul>
  <div class="dropdown">
    <button class="dropbtn" class="active-button">Ranking</button>
    <div class="dropdown-content">
      <a href="Ranking-GDP.php" class="active-page">GDP</a>
...
if (isset($id)) { 
    $getQuery = "SELECT Country, GDP, Ranking FROM CountryGDP  WHERE Country = :id";
...
<th>Rank</th>
 ...
 $sql = 'SELECT Country, GDP, Ranking FROM CountryGDP order by Ranking ';
