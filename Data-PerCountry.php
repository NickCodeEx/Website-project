...
<div class="dropdown">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
     ...
     <a href="Data-PerCountry.php" class="active-page">Per country</a>
    </div> 
  </div>
...
if (isset($id)) { 
   $getQuery = "SELECT Country,Population,GDP, Size, Continents FROM CountryData  WHERE Country = :id";
   ...
   echo "<td>" . htmlspecialchars($product["GDP"]) . "</td>";
   echo "<td>" . htmlspecialchars($product["Size"]) . "</td>";
   echo "<td>" . htmlspecialchars($product["Continents"]) . "</td>";
   echo "</tr>";
   echo "</table>";
}
...
<th>Continent</th>
 ...
 $sql = 'SELECT Country,Population,GDP, Size, Continents FROM CountryData ';
 foreach ($pdo->query($sql) as $row) {
   ...
   echo "<td>" . htmlspecialchars($row['Continents']) . "</td>";
   echo "</tr>";
 }
 echo "</table>";
}
