...
<ul>
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="Ranking-Size.php" class="active-page">Size</a>
...
if (isset($id)) { 
   $getQuery = "SELECT Country, Size, Ranking FROM CountrySize  WHERE Country = :id";
...
<th>Rank</th>
 ...
 $sql = 'SELECT Country, Size, Ranking FROM CountrySize order by Ranking ';
